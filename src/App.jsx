                ...
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 8 }}>
                  <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                    ...
                    <span style={{ fontSize: 11, padding: "2px 8px", borderRadius: 20, fontWeight: 600,
                      ...
                      {activeTab === "buy" ? `${stock.currentHolding}주 보유` : "매도"}
                    </span>
                  </div>
                  <div style={{ textAlign: "right" }}>
                    <div style={{ fontSize: 13, fontWeight: 700, color: activeTab === "buy" ? "#ef4444" : "#3b82f6" }}>
                      {activeTab === "buy" ? stock.avgBuyPrice?.toLocaleString() : sellPieData.find(s=>s.ticker===stock.ticker)?.avgPrice?.toLocaleString()}원
                    </div>
                    <div style={{ fontSize: 11, color: "#64748b" }}>평균단가</div>
                  </div>
                </div>
